...
class ExtendsCanvas3D extends Canvas3D {
        ...
        */
        ...
        for (let i = 0; i <= VERTEX_COUNT; ++i) {
            ...
            for (let j = 0; j <= VERTEX_COUNT; ++j) {
                ...
                // 平面形状
                {
                   this.planePositions.push(x, y, 0.0);
                }
                ...
                // 球形上
                {
                    ...
                    this.spherePositions.push(x02 * xz02Raidus, y02, z02 * xz02Raidus);
                }

                // 頂点色
                this.pointColors.push(i / VERTEX_COUNT, 0.5, j / VERTEX_COUNT, 1.0);
    ...
    getAttributeLoactions() {
        return [
            this.gl.getAttribLocation(this.shaderProgram, 'planePositions'),
            this.gl.getAttribLocation(this.shaderProgram, 'spherePositions'),
     ...
     */
    getPointCount() {
        return this.spherePositions.length / 3;
    }
    ...
    // uniformには変数、変数タイプ、変数に渡す値が一つのセットになっている
    // これをメソッドでバラバラにすると追加・削除が手間になる
    // オブジェクトでひとまとめにするのが良いか
    // しかしその代わり変数値を共有するケースではまた工夫が必要になる
    /**
     * Uniformの変数
     */
    getUniformLocations() {
