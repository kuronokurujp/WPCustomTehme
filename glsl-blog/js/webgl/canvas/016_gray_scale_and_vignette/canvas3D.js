...
class ExtendsCanvas3D extends Canvas3D {
    constructor() {
        ...
        this.graySaturation = 0.0;
        this.vignetteValue = 1.5;
    }
       ...
       // グレースケール調整
        {
            ...
            PANE.addInput({'gray': this.graySaturation}, 'gray', {min: 0, max: 1.0})
            .on('change', (v) => {
                this.graySaturation = v;
            });
        }
        ...
        // ヴィネット調整
        {
            ...
            // 値のオブジェクト名と初期値設定の引数名と一致しないとエラーになる
            PANE.addInput({'vignette': this.vignetteValue}, 'vignette', {min: 0, max: 2.0})
            .on('change', (v) => {
                this.vignetteValue = v;
            });
        }
        ...
        // ポストエフェクト用のシェーダー作成とそれに関する情報生成
        {
            ...
            // グレースケールの飽和値
            shaderFrame.createUniformLocation('graySaturation', 'uniform1fv');
            // ヴィネットの補正値
            shaderFrame.createUniformLocation('vignetteValue', 'uniform1fv');
