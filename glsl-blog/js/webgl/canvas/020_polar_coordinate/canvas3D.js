    ...
    setup(webGLFrame, shaderFrames) {
        ...
        */
        ...
        // 時間係数
        {
            ...
            PANE.addInput({'timeScale': this.timeScale}, 'timeScale', {min: 0.0, max: 0.5})
            .on('change', (v) => {
                this.timeScale = v;
            });
        }
        ...
        // ノイズ可視化
        {
            ...
            PANE.addInput({'noiseView': this.noiseViewFlag}, 'noiseView')
            .on('change', (v) => {
                this.noiseViewFlag = v;
            });
        }
        ...
        // 極座標使用
        {
            ...
            PANE.addInput({'polarCoordinate': this.polarCoordinateFlag}, 'polarCoordinate')
            .on('change', (v) => {
                this.polarCoordinateFlag = v;
            });
        }
        ...
        // ノイズタイプ
        {
            ...
            PANE.addInput({'noiseType': this.noiseType}, 'noiseType', {step:1, min:0, max:1})
            .on('change', (v) => {
                this.noiseType = v;
            });
        }
        ...
        // ポストエフェクト用のシェーダー作成とそれに関する情報生成
        {
            ...
            shaderFrame.createUniformLocation('textureUnit01', 'uniform1i');
            // ノイズテクスチャ
            shaderFrame.createUniformLocation('noiseTextureUnit02', 'uniform1i');
            ...
            // タイム係数
            shaderFrame.createUniformLocation('timeScale', 'uniform1f');
            // ノイズ可視化
            shaderFrame.createUniformLocation('noiseViewFlag', 'uniform1i');
            // 極座標変更
            shaderFrame.createUniformLocation('polarCoordinateFlag', 'uniform1i');
            // ノイズタイプ
            shaderFrame.createUniformLocation('noiseType', 'uniform1i');
